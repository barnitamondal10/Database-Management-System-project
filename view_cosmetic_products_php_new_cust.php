...
echo "</table>";
echo "<center>";
echo "<form action=\"http://localhost/cosmetics/front.html\" method=POST>";
echo "</br></br></br>";
echo "<b><input type=\"submit\" name=\"button\"style=\"height: 50px; width: 170px\"  value=\"LOGOUT\" style=\"float: right;\"></b></td>";
echo "</form>";
echo "</center>";
