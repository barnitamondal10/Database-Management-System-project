...
body{
background-image: url(edit_cp.jpg);
...
<div class="aa">
<head>
<title>UPDATE COSMETIC_PRODUCT RECORDS</title>
</head>
<?php
...
<td><a href="update_cosmetic_products_php.php?e_cpid=<?php echo $row['cpid']; ?>" alt="EDIT"><b><h3>EDIT</h3></b></a></td>
