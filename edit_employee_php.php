...
body{
background-image: url(edit_employee.jpg);
...
echo "<h1 align=\"left\"><u><b>EMPLOYEE  DETAILS</h1></b></u>";
...
<td><a href="update_employee_php.php?e_eid=<?php echo $row['eid']; ?>" alt="EDIT"><b><h3>EDIT</h3></b></a></td>
<?php
echo "</tr>";
}
echo "</table>";
